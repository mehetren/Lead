...
#
#    ${contact_id} =       Salesforce Insert  Lead
#    ...                     FirstName=${first_name}
#    ...                     LastName=${last_name}
#
#    &{contact} =          Salesforce Get  Lead  ${contact_id}
...
Via UI
    ...
    Wait for modal        New  Lead
    Log      Get current user experience
    Populate Form
    Click Button          Next
...
#    Click Element    //span[@title='Marketing']
...
#    Store Session Record  Lead  ${contact_id}
#    Validate Contact      ${contact_id}  ${first_name}  ${last_name}
#
#
#*** Keywords ***
